//
//  TestHexCenterPointsOddFlat6x6.swift
//  HexKit
//
...
class TestHexCenterPointsOddFlat6x6: XCTestCase {
    ...
    func test_Q0() {
        ...
        XCTAssertEqualWithAccuracy (tile.center.x, 22.0, accuracy: accuracy, "Expected result not equal");
        XCTAssertEqualWithAccuracy (tile.center.y, 95.2627944162883, accuracy: accuracy, "Expected result not equal");
